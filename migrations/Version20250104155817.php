 ...
 */
final class Version20250104155817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE act_image (
          id INT AUTO_INCREMENT NOT NULL,
          att_id_id INT DEFAULT NULL,
          image VARCHAR(255) NOT NULL,
          INDEX IDX_15959B49D9923973 (att_id_id),
          PRIMARY KEY(id)
        ) DEFAULT CHARACTER
        SET
        ...
        $this->addSql('CREATE TABLE activities (
          ...
          act_descr LONGTEXT DEFAULT NULL,
          date DATE NOT NULL,
          ...
          INDEX IDX_B5F1AFE5B03A8386 (created_by_id),
          PRIMARY KEY(id)
        ) DEFAULT CHARACTER
        SET
          utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE attendance (
          ...
          INDEX IDX_6DE30D916146A8E4 (activity_id_id),
          PRIMARY KEY(id)
        ) DEFAULT CHARACTER
        SET
          utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE attendance_members (
          attendance_id INT NOT NULL,
          members_id INT NOT NULL,
          INDEX IDX_42673CFD163DDA15 (attendance_id),
          INDEX IDX_42673CFDBD01F5ED (members_id),
          PRIMARY KEY(attendance_id, members_id)
        ) DEFAULT CHARACTER
        SET
          utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fund_transactions (
          id INT AUTO_INCREMENT NOT NULL,
          executed_by_id INT DEFAULT NULL,
          amount NUMERIC(10, 3) NOT NULL,
          fund_descr LONGTEXT DEFAULT NULL,
          date DATETIME NOT NULL,
          INDEX IDX_3DBA1C778B35AB5C (executed_by_id),
          PRIMARY KEY(id)
        ) DEFAULT CHARACTER
        SET
          utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE members (
          ...
          UNIQUE INDEX UNIQ_45A0D2FF9D86650F (user_id_id),
          PRIMARY KEY(id)
        ) DEFAULT CHARACTER
        SET
          utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE act_image DROP FOREIGN KEY FK_15959B49D9923973');
        ...
        $this->addSql('DROP TABLE act_image');
