 ...
 */
class getActivitiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActivitiesRepository' shared autowired service.
     *
     * @return \App\Repository\ActivitiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActivitiesRepository.php';

        return $container->privates['App\\Repository\\ActivitiesRepository'] = new \App\Repository\ActivitiesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
