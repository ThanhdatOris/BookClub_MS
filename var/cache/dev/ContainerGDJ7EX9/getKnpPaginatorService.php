...
class getKnpPaginatorService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['knp_paginator'] = $container->createProxy('PaginatorProxyBa079e5', static fn () => \PaginatorProxyBa079e5::createLazyProxy(static fn () => self::do($container, false)));
        }
