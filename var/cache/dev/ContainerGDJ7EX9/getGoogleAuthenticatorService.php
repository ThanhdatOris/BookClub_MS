...
class getGoogleAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['debug.App\\Security\\GoogleAuthenticator'])) {
            return $container->privates['debug.App\\Security\\GoogleAuthenticator'];
        }

        return $container->privates['debug.App\\Security\\GoogleAuthenticator'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticator(new \App\Security\GoogleAuthenticator($a, ($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack())));
    }
}
