 ...
 */
class getActivityParticipantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActivityParticipantRepository' shared autowired service.
     *
     * @return \App\Repository\ActivityParticipantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActivityParticipantRepository.php';

        return $container->privates['App\\Repository\\ActivityParticipantRepository'] = new \App\Repository\ActivityParticipantRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
