...
class __TwigTemplate_f78a1fc52cec043a02ea4720fa33b478 extends Template
{
    ...
    <div class=\"card-header bg-gradient-primary text-white\">
        <h3 class=\"mb-0\">Chỉnh sửa thành viên</h3>
    </div>
    <div class=\"card-body\">
        ";
        // line 11
        yield Twig\Extension\CoreExtension::include($this->env, $context, "users/_form.html.twig", ["button_label" => "Update"]);
        yield "
    </div>
...
";
    ...
    {
        return array (  119 => 17,  113 => 14,  107 => 11,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}Chỉnh sửa thành viên{% endblock %}
...
<div class=\"card shadow-lg border-0\">
    ...
    <div class=\"card-body\">
        {{ include('users/_form.html.twig', {'button_label': 'Update'}) }}
    </div>
    <div class=\"card-footer d-flex justify-content-between\">
        <a href=\"{{ path('app_users_index') }}\" class=\"btn btn-secondary\">
            <i class=\"fas fa-arrow-left\"></i> Quay lại danh sách
        </a>
...
{% endblock %}
", "users/edit.html.twig", "C:\\laragon\\www\\BookClub_MS\\templates\\users\\edit.html.twig");
    }
}
