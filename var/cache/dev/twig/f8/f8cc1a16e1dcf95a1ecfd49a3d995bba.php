...
class __TwigTemplate_52c502735e3482c8554f982cbd06dd1b extends Template
{
...
<html lang=\"en\">
    <head>
        ...
        // line 11
        yield "        ";
        $context["status_code"] = (( !(null === (isset($context["request_collector"]) || array_key_exists("request_collector", $context) ? $context["request_collector"] : (function () { throw new RuntimeError('Variable "request_collector" does not exist.', 11, $this->source); })()))) ? (((CoreExtension::getAttribute($this->env, $this->source, ($context["request_collector"] ?? null), "statuscode", [], "any", true, true, false, 11)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["request_collector"]) || array_key_exists("request_collector", $context) ? $context["request_collector"] : (function () { throw new RuntimeError('Variable "request_collector" does not exist.', 11, $this->source); })()), "statuscode", [], "any", false, false, false, 11), 0)) : (0))) : (0));
        // line 12
        yield "        ";
...
", "@WebProfiler/Profiler/base.html.twig", "C:\\laragon\\www\\BookClub_MS\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\base.html.twig");
    }
}
