 ...
 */
class getFundsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FundsRepository' shared autowired service.
     *
     * @return \App\Repository\FundsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FundsRepository.php';

        return $container->privates['App\\Repository\\FundsRepository'] = new \App\Repository\FundsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
