 ...
 */
class getAttendancesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AttendancesRepository' shared autowired service.
     *
     * @return \App\Repository\AttendancesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AttendancesRepository.php';

        return $container->privates['App\\Repository\\AttendancesRepository'] = new \App\Repository\AttendancesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
