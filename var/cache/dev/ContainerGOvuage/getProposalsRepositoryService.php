 ...
 */
class getProposalsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProposalsRepository' shared autowired service.
     *
     * @return \App\Repository\ProposalsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProposalsRepository.php';

        return $container->privates['App\\Repository\\ProposalsRepository'] = new \App\Repository\ProposalsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
