...
final class AttendancesController extends AbstractController
{
    ...
    public function index(AttendancesRepository $attendancesRepository, ActivityParticipantRepository $participantRepository): Response
    {
        $activities = $this->getDoctrine()->getRepository(Activities::class)->findBy([], ['created_at' => 'DESC']);
